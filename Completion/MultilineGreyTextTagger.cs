...
namespace HandyTools
{
    ...
    internal sealed class MultilineGreyTextTagger : ITagger<CompletionTag>
    {
        ...
        public bool SetSuggestion(String newSuggestion, int caretPoint)
        {
            ...
            {
                Log.OutputAsync("Exception: " + ex.ToString());
                return false;
            }
        }
        ...
        public bool Update(){
            ...
            int suggestionIndex = Commands.CodeUtil.CheckSuggestion(suggestion.Item1, line);
        ...
        public bool CompleteText(){
            ...
            int suggestionLineN = Commands.CodeUtil.CheckSuggestion( suggestion.Item1, line);
